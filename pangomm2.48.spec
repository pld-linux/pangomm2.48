...
License:	LGPL v2+
Group:		X11/Libraries
Source0:	https://download.gnome.org/sources/pangomm/2.56/pangomm-%{version}.tar.xz
# Source0-md5:	54f80e1204be44a97a2c831fec904ae9
...
%{_libdir}/libpangomm-%{apiver}.*.*.*
%ghost %{_libdir}/libpangomm-%{apiver}.so.1
